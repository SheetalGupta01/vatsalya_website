        <?php 
			...
			$qry = "SELECT * FROM feedback ".$where." order by createdon desc";
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
								...
								<form action name="feedback_form" action="" method="post">
                                    ...
                                    <table class="table" id="feedbackTable">
										...
										?>
                                            <tr>
                                                ...
                                                <td><a href="feedback_detail.php?id=<?php echo $page['id']; ?>" class="btn">Detail</a></td>
                                            </tr>
										<?php } ?>
                                        </tbody>
                                    </table>
